class ScheduleUser {
  ...
  // api 완성되기 전 dummy 값
  static List<ScheduleUser> getDummyScheduleDetailList() {
    return [
      ScheduleUser(1, 1, DateTime.parse('2024-05-15T13:00:00'), 'ee', 'dummy',
          'dummy_center', 'dummy_loc', 3),
      ScheduleUser(1, 1, DateTime.parse('2024-05-15T15:00:00'), 'ee', 'dummy',
          'dummy_center', 'dummy_loc', 3)
    ];
  }
}
